	...
	var methods = {
		...
		init : function( options )
		{
			...
			var statusBar = $("<div/>", {	id : "statusbar",
	       	...
	       	if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").html('<div className="label">'+'Words : '+wordCount+'</div>');
					$(editor_Content).data("statusBar").append('<div className="label">'+'Characters : '+charCount+'</div>');
            	});
	        }	        
		    ...
		    $(document.body).mousedown(function(event) {
		        ...
		        if (!target.parents().andSelf().is('#specialchar') && (target.closest('a').html()!='<i className="fa fa-asterisk"></i>')) { //Clicked outside
		        ...
		        if (!target.parents().andSelf().is('#paletteCntr') && (target.closest('a').html()!='<i className="fa fa-font"></i>')) { //Clicked outside
